...
const Learn = () => {
  ...
  useEffect(() => {
    const fetchFromDB = () => {
      const mockData = [
        { id: 1, name: 'Plastik', image: 'https://images.unsplash.com/photo-1532634922-8fe0b757fb13?w=600' },
        { id: 2, name: 'Organik', image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=500' },
        { id: 3, name: 'E-Waste', image: 'https://images.unsplash.com/photo-1555664424-778a1e5e1b48?w=500' },
        { id: 4, name: 'Kertas', image: 'https://images.unsplash.com/photo-1603481546238-487240415921?w=500' },
        { id: 5, name: 'Kaca', image: 'https://images.unsplash.com/photo-1577705993359-8771912555b2?w=500' },
        { id: 6, name: 'Logam', image: 'https://images.unsplash.com/photo-1536566482680-fca31930a0bd?w=500' },
        { id: 7, name: 'Berbahaya', image: 'https://images.unsplash.com/photo-1584438784894-089d6a128f3e?w=500' },
      ];
    ...
    <section id="learn" className={sectionWrapper}>
      ...
      <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-5 md:space-y-6 md:w-[40%]">
        ...
        <h2 className="text-[32px] md:text-5xl font-extrabold text-primary leading-[1.2] md:leading-tight font-['Segoe_UI']">
          Pilah Benar, Bumi Segar.
        </h2>
        
        <p className="text-primary/70 leading-relaxed text-sm md:text-base max-w-[320px] md:max-w-full">
          Beda sampah, beda cara buangnya. Kenali jenis bahan dan temukan cara daur ulang yang pas buatmu.
        </p>
